...
- Map lifecycle uses ResizeObserver + orientation/visibility resize hooks to improve mobile rendering stability.
- Algarve import uses free OSM Overpass API and deduplicates by course name.
